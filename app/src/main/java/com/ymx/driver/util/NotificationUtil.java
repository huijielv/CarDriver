...
public class NotificationUtil {
    public static final String CHANNELID = "定位";
    public static final String CHANNELNAME = "定位";
    ...
    public static Notification buildNotification(Context context, String channelId, String channelName) {
        ...
        Notification.Builder builder = new Notification.Builder(UIUtils.getContext())
                ...
                .setContentText(context.getString(R.string.app_name) + "正在获取您的位置");
