...
import com.ymx.driver.mqtt.message.TransferNewOrderMessage;

public class TransferNewOrderFactory implements MqttConfigFactory {
    @Override
    public SendMessage createMessage() {
        return  new TransferNewOrderMessage();
    }
}
