package com.ymx.driver.map.overlay;
...
public class DrivingRouteOverlay extends RouteOverlay {
    ...
    private float mWidth = UIUtils.dip2px(16);
    ...
    private void initPolylineOptions() {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.traffic_standard);
        mPolylineOptions.setCustomTexture(BitmapDescriptorFactory.fromBitmap(bitmap));
    ...
    private void colorWayUpdate(List<TMC> tmcSection) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.traffic_standard);
        mPolylineOptionscolor.setCustomTexture(BitmapDescriptorFactory.fromBitmap(bitmap));
    ...
    private int getcolorRes(String status) {
        if (status.equals("畅通")) { // 畅通情况下 绿色显示
            return R.drawable.traffic_standard;
        } else if (status.equals("缓行")) { // 缓行情况下 黄色显示
            return R.drawable.traffic_abnormall;
        } else if (status.equals("拥堵")) { // 拥堵情况下 红色显示
            return R.drawable.traffic_congestedl;
        } else if (status.equals("严重拥堵")) {  // 严重拥堵 猪肝红显示
            return R.drawable.traffic_heavy;
        } else { // 未知情况下蓝色显示
            return R.drawable.traffic_unknown;
        }
    }


    protected int getDriveColorRes() {
        return R.drawable.traffic_standard;
    }
