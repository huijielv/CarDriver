...
public class FinishTripOrderFrament extends BaseFragment<FramentNotFinishTripBinding, NotFinishTripViewModel> {
    ...
    public void initView(Bundle savedInstanceState) {
        binding.refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                viewModel.refreshOrder(2, 10, viewModel.pagerIndex.get());
            }
        });
        binding.refreshLayout.setOnMultiPurposeListener(new SimpleMultiPurposeListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                ...
                viewModel.getTripOrderList(2, 10, viewModel.pagerIndex.get());
