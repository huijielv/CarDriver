...
import com.ymx.driver.databinding.ActivityTransferFinishDetailsBinding;
...
public class TransferStationTripOrderFinishDetailsActivity extends BaseActivity<ActivityTransferFinishDetailsBinding , LongRangDrivingFinishViewModel> {
    ...
    public static void start(Activity activity, Intent extras) {
        ...
        intent.setClass(activity, TransferStationTripOrderFinishDetailsActivity.class);
        if (extras != null) {
    ...
    public int initLayoutId(Bundle savedInstanceState) {
        return R.layout.activity_transfer_finish_details;
    }
    ...
    public void initData() {
        ...
        if (intent.hasExtra(ORDERI_ID)) {
            ...
            viewModel.transferOrderFinishDetails(orderNo);
