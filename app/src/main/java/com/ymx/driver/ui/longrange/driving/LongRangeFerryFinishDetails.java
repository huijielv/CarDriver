...
import com.ymx.driver.databinding.ActivityLongRangeFerryFinishDetailsBinding;
...
import com.ymx.driver.viewmodel.longrangdriving.LongRangeFerryFinishViewModel;

public class LongRangeFerryFinishDetails extends BaseActivity<ActivityLongRangeFerryFinishDetailsBinding , LongRangeFerryFinishViewModel> {
    ...
    public static void start(Activity activity, Intent extras) {
        ...
        intent.setClass(activity, LongRangeFerryFinishDetails .class);
        if (extras != null) {
    ...
    public int initLayoutId(Bundle savedInstanceState) {
        return R.layout.activity_long_range_ferry_finish_details;
    }
