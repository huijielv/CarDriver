 ...
 */
package com.ymx.driver.view.wheelview.graphics;
...
public class HoloDrawable extends WheelDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (mItemH != 0) {
            ...
            canvas.drawLine(0, mItemH * (mWheelSize / 2 + 1) + mStyle.holoBorderWidth, mWidth, mItemH
                    * (mWheelSize / 2 + 1) + mStyle.holoBorderWidth, mHoloPaint);
        }
    }
}
